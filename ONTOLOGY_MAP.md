...
| `maker_checker` | Pattern de validation double | ATOM-026 | L0-CANON/unified-design/conventions/maker-checker |
| `default_fail` | Principe de sécurité par défaut | ATOM-027 | L0-CANON/unified-design/conventions/default-fail |
