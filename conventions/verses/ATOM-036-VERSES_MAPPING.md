...
| Persona | Rôle | Canal |
|---------|------|-------|
| Architecte | Conçoit la solution | Machine |
| Implémenteur | Code l'implémentation | Machine |
| Auditeur | Vérifie la cohérence | Humain |
| Décideur | Valide le résultat | Humain |
