...
- **ADR-031** : [RLM-TLM Integration via KIX](ADR-031-rlm-tlm-integration.md)
- **ADR-032** : [Clone Governance](ADR-032-clone-governance.md)
- **ADR-033** : [Symbol Retrieval MCP (Serena Pattern)](ADR-033-symbol-retrieval-mcp.md)
- **ADR-034** : [Agent Worktree Isolation (Git Worktree per Agent)](ADR-034-agent-worktree-isolation.md)
- **ADR-035** : [Beads SQL Versioned Memory (L1 Beads)](ADR-035-beads-sql-memory.md)
...
- **ADR-2026-09-22-001** : [Symbiose Reversible Architecture](ADR-SYMBIOSE-REVERSIBLE-ARCHITECTURE-20260922.md)
- **ADR-2026-09-22-002** : [Reversible Symbiose Lifecycle](ADR-REVERSIBLE-SYMBIOSE-LIFECYCLE-20260922.md)
- **ADR-2026-09-22-003** : [Symbiose Coordinated Reload](ADR-SYMBIOSE-COORDINATED-RELOAD-20260922.md)

## ADRs GOVERNANCE-HUB (méta-gouvernance)

Les ADRs liés au Meta-Design se trouvent dans le dépôt GOVERNANCE-HUB :

- **ADR-013** : [Meta-Design Validation Protocol](https://github.com/gerivdb/GOVERNANCE-HUB/blob/main/ADR/ADR-013-meta-design-validation-protocol.md)

Pour créer un nouvel ADR, utilisez le pattern : `ADR-{3digits}-{slug}.md`